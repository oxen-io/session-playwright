...
export const en = {
  ...
  callsVoiceAndVideoModalDescription: 'Your IP is visible to your call partner and an Oxen Foundation server while using beta calls.',
  ...
  deleteMessageDescriptionDevice: 'Are you sure you want to delete this message from this device only?',
  ...
  permissionsCameraDenied: '{app_name} needs camera access to take photos and videos, but it has been permanently denied. Tap Settings -> Permissions, and turn "Camera" on.',
  ...
  permissionsMicrophoneAccessRequired: '{app_name} needs microphone access to make calls and send audio messages, but it has been permanently denied. Tap settings -> Permissions, and turn "Microphone" on.',
