...
test_Alice_1W_Bob_1W('Send image 1:1', async ({ alice, alice1, bob, bob1 }) => {
...
test_Alice_1W_Bob_1W('Send video 1:1', async ({ alice, alice1, bob, bob1 }) => {
...
test_Alice_1W_Bob_1W('Send GIF 1:1', async ({ alice, alice1, bob, bob1 }) => {
  // const testReply = `${bob.userName} to ${alice.userName}`;
  await createContact(alice1, bob1, alice, bob);
...
test_Alice_1W_Bob_1W('Send link 1:1', async ({ alice, alice1, bob, bob1 }) => {
